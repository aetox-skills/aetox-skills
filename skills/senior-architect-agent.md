...
- An existing codebase or software system must be mapped.
...
- The task is only a small code edit with no architecture impact.

## Repository

https://github.com/aetox-skills/senior-architect-agent
